...
package io.stateoftheart.netcam.ml;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
  ...
  private void processImage(
    ...
    Bitmap bitmap =
        true/*PreferenceUtils.isCameraLiveViewportEnabled(graphicOverlay.getContext())*/
            ? null
  ...
  private Task<T> setUpListener(
    ...
    return task.addOnSuccessListener(
            ...
            results -> {
              ...
              if (! false /*PreferenceUtils.shouldHideDetectionInfo(graphicOverlay.getContext())*/) {
                graphicOverlay.add(
